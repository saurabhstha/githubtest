...
public class AddtocartStepDefinations {
    ...
    public void user_should_be_able_to_add_to_cart(){
        WebDriverWait wait = new WebDriverWait(SingletonBrowserClass.getInstanceOfSingletonBrowserClass().getDriver(), Duration.ofSeconds(10));
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class ='btn btn_primary btn_small btn_inventory']")).();
